...
const CREW = [
  { name: "Aarav Krishnan", role: "PRESIDENT", handle: "@aarav.builds", line: "Ships the vision, reviews the PRs.", glyph: "AK" },
  { name: "Diya Sharma", role: "VICE PRESIDENT", handle: "@diya.exe", line: "Runs the ops grid so builders can build.", glyph: "DS" },
  { name: "Ishaan Verma", role: "TECH LEAD", handle: "@ishaan.kernel", line: "Owns the rack, the cluster and the uptime.", glyph: "IV" },
  { name: "Meera Nair", role: "EVENTS LEAD", handle: "@meera.launch", line: "Turns spreadsheets into 200-person rooms.", glyph: "MN" },
  { name: "Rohan Iyer", role: "DESIGN LEAD", handle: "@rohan.pixels", line: "Makes terminals look like cinema.", glyph: "RI" },
  { name: "Sara Thomas", role: "OUTREACH LEAD", handle: "@sara.uplink", line: "Dials industry, alumni and the feed.", glyph: "ST" },
];
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:py-28">
        <div ref={ref} className={`reveal ${seen ? "is-visible" : ""}`}>
          ...
          <p className="mt-3 max-w-xl text-sm text-muted-foreground sm:text-base">
            Six humans who keep the compile times short and the vibes compiling.
          </p>
              ...
              >
                ...
                <div className="flex items-start gap-4 p-5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-0.5 font-mono text-[10px] text-muted-foreground">{c.handle}</p>
        ...
        <div ref={qRef} className={`reveal ${qSeen ? "is-visible" : ""} mt-12`}>
          <div className="scanlines relative overflow-hidden rounded-md border border-primary/25 bg-gradient-to-br from-secondary/60 to-card p-8 sm:p-10">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <div>
                <p className="font-mono text-xs font-bold text-foreground">Aarav Krishnan</p>
                <p className="font-mono text-[10px] text-muted-foreground">
                  President, NEXUS · VIT Chennai
                </p>
              </div>
            </div>
          </div>
