...
const CREW = [
  {
    ...
    role: "CHAIRPERSON",
    glyph: "RS",
    quote: "Lead the vision, inspire, and empower. Presenting the Chairperson.",
  },
  {
    name: "Aryan Kotwal",
  ...
  },
  {
    ...
    role: "PROJECT HEAD",
    glyph: "AKS",
    quote: "Transform ideas into impactful projects. Representing the Project Lead.",
  },
  {
    name: "Prakar Gupta",
    role: "EVENTS LEAD",
    glyph: "PG",
    quote: "Create memorable events and experiences. Presenting the Event Lead.",
  },
  {
    name: "Jyoti Yadav",
    role: "CLUB COORDINATOR",
    glyph: "JY",
    quote: "Coordinate people, plans, and progress. Presenting Club Coordinator.",
  },
  {
    name: "Pranav Anandan",
    role: "TECHNICAL LEAD",
    glyph: "PA",
    quote: "Innovate, build, and solve challenges. Representing Technical Lead.",
  },
];
...
export function Team() {
  ...
  return (
    <section id="team" className="relative border-b border-border/60 bg-[#060a12]">
        ...
        <div ref={ref} className={`reveal ${seen ? "is-visible" : ""}`}>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {CREW.map((c) => (
              <article
                key={c.name}
                className="group relative overflow-hidden rounded-md border border-border bg-card transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/45 hover:shadow-[0_8px_40px_rgba(96,165,250,0.08)]"
              >
                {/* ascii pattern banner */}
                <div className="relative h-16 overflow-hidden border-b border-border/60 bg-[#05080d]">
                  ...
                  <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent,rgba(5,8,13,0.9))]" />
                ...
                <div className="flex items-start gap-4 p-5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-2 text-xs leading-relaxed text-muted-foreground">{c.quote}</p>
